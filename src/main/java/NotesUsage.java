...
public class NotesUsage {
    ...
    private static void homework2Usage(){
        ...
        noteStorage.addNote(new Note("Kids", "Children are completely egoistic; they feel their needs intensely and strive ruthlessly to satisfy them.", new Date(), user0, CategoryEnum.DIARY));
        ...
        noteStorage.addNote(new Note("Chemistry", "The meeting of two personalities is like the contact of two chemical substances: if there is any reaction, both are transformed", new Date(), user1, CategoryEnum.THOUGHTS));
        noteStorage.addNote(new Note("Me", "I am not what happened to me, I am what I choose to become.", new Date(), user1, CategoryEnum.DIARY));
